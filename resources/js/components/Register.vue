    ...
    <modal name="register" height="auto" :scrollable="true">
            ...
            <div style="text-align: center;"><h5> Register</h5></div>
                <div class="form-group ">
                        <input id="username" type="text" class="form-control" name="username"  placeholder="Username" required autofocus style="border-radius: 15px;">
                </div>
                <div class="form-group ">
                    <div class="">
                        <input id="email" type="email" class="form-control" placeholder="something@eMail.com" required style="border-radius: 15px;">
                ...
                <div class="form-group ">
                    <div class="">
                        <input id="password" type="password" class="form-control" placeholder="Password|min:8 characters" name="password" style="border-radius: 15px;" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="">
                ...
                <div class="form-group  mb-6">
                    <div class="">
                        <button type="submit" class="btn btn-secondary btn-xtrm btn-block">
                         ...
                         <div><button @click="$modal.hide('register')" class="btn btn-danger btn-block">Cancel</button></div>
                    </div> <br>
