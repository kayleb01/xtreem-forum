        ...
        @if(Auth::check()) 
          <div class="pane-widget p-2 ">
              <ul class="list-group mt-1 list-wig p-2">
                <li class=" mb-2 first-item"><a href="/u/{{Auth::user()->username}}"><img src="/storage/storage/img/{{Auth::user()->avatar? Auth::user()->avatar : 'default.jpg'}}" class="image-circle rounded-pill"></a></li>   
