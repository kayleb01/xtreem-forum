    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
            <a   class="btn btn-secondary rounded-pill mb-2 text-light" style=" color: #fff;" href="/forum/{{$threads[0]->forum->id}}/create">
                <span style="margin: 7px;">New Topic</span></a>
                    	...
                    	<div class="panel-body bk" style="padding:6px; border: none;"><a href="/u/{{$thread->user->username}}"><img class="image-circle" src="/storage/img/{{$thread->user->avatar? $thread->user->avatar : 'default.jpg'}}"></a>
                    			<span class="title">
                    				...
                    				<span class="details">
                                     ...
                                     <span class="c"><i class="fa fa-comment"></i>&nbsp;{{$thread->replies_count}} {{Str::plural('comment', $thread->replies_count)}}</span>&nbsp;&nbsp;<span class="v">&nbsp;{{$thread->visits}} {{Str::plural('view', $thread->visits)}}</span>&nbsp;&nbsp;<span class="tm"> {{$thread->created_at->diffForHumans()}}</span>
                    				</span>
                    		</div>
                    	@endforeach
                    	</div>
