        ...
        <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <ol class="breadcrumb">
                       <li><a href="/">Home</a></li>
                       <li>{{$users->username.'\'s Threads'}}</li>
                    </ol>
                </div> 
                          ...
                          <span class="title">
                            ...
                            <span class="details">
                             ...
                             Posted by  <a href="/user/{{$thread->user->username}}">{{$thread->user->username}}</a>
                                     <span class="tm"><i class="fa fa-comment"></i>&nbsp;{{$thread->replies_count}} {{str_plural('comment', $thread->replies_count)}}</span>&nbsp;&nbsp;<span class="v">&nbsp;{{$thread->visits}} {{str_plural('view', $thread->visits)}}</span>&nbsp;&nbsp;<span class="tm">published on {{$thread->created_at->diffForHumans()}}</span>                      
                            </span>
                        </div>
                      @endforeach
                      </div>
