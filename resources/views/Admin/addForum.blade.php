...
<div style="min-height: 822px;" class="content-wrapper">
  <section class="content-header">
    <h1><i class="fa fa-dashboard"></i> Create New Forum</h1>
            <ol class="breadcrumb">
				<li><a href="/admin">Admin Panel</a>
				</li>
				<li><a href="/admin/forums">Forum list</a></li>
				<li class="active">New Forum</li>
			</ol>
  ...
  <div class="alert-field" id="alert-field"></div> 
    ...
    <div class="box box-flat">
        ...
        <div class="box-body padding">
			<form method="POST" class="form-horizontal" action="{{route('admin/store/forum')}}" enctype="multipart/form-data">
						{{csrf_field()}}
						...
						<div class="col-sm-10">
						<textarea name="description" class="form-control" placeholder="Short description of the forum"></textarea>
						</div>
						</div>
							<div class="form-group">
