...
<div style="min-height: 822px;" class="content-wrapper">
  <section class="content-header">
    <h1 class="well-sm" style="background-color:#fff;">Deleted Users</h1>
            <ol class="breadcrumb">
  ...
  <div class="alert-field" id="alert-field"></div> 
    ...
    <div class="box box-flat">
        <div class="box-header">
            <h3 class="box-title">Deleted users</h3>
        </div>
        	...
        	<tbody>
                ...
                @foreach($user as $users)
                	<tr>
						...
						<td class="hidden-sm hidden-xs">{{($users->deleted_at)}}</td>
						<td>
						<div class="dropdown">
						...
						<li role="presentation">
						    <a role="menuitem" tabindex="-1" href="{{url('admin/users/' . $users->id . '/restore')}}">Restore</a>
						</li>
						</ul>
						</div>
						</td>
