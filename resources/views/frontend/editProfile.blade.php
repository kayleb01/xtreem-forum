...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="jumbotron bg-img mt-2 text-light d-flex justify-content-center" style="height: 108px !important; margin-bottom: 85px;">
              <div class="img_edit ttext-light"><i class="fa fa-edit">edit</i></div>
			...
			<div class="panel panel-body" style="padding:20px;">
				...
				<form action="u/threads/{{$user->username}}" enctype="multipart/form-data" method="POST">
				<div class="form-group">
					 <label for="birthday" class="col-md-4 col-form-label ">{{ __('Upload new profile picture') }}</label>
